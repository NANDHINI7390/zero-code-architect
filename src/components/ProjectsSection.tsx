  ...
  const projects = [
    {
      ...
      description:
        "Built using Bubble.io, this app takes user food preferences and generates AI-powered recipes with a grocery list. The list is sent to WhatsApp using Make.com and includes a link to order ingredients via Amazon Fresh. A smart AI + Automation use case.",
    ...
    },
    {
      ...
      description:
        "Custom workflow automation solution created with n8n and Make integrating multiple business systems.",
      tags: ["n8n", "Make", "Automation", "Integration"],
      image:
        "https://images.unsplash.com/photo-1607706189992-eae578626c86?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    ...
    },
    {
      ...
      description:
        "A dynamic dashboard for data visualization built with no-code tools and real-time data processing.",
      tags: ["Visual Dev", "Dashboard", "Data", "Design"],
      image:
        "https://i.ibb.co/rKypxSC7/Screenshot-2025-05-19-09-40-35-99-40deb401b9ffe8e1df2f1cc5ba480b12.jpg",
    ...
    },
    {
      title: "AI Agent",
      description:
        "This project will involve building an intelligent AI assistant capable of handling user queries using NLP. It will integrate with Bubble.io, Make.com, and possibly messaging platforms to demonstrate smart automation.",
    ...
    <section id="projects" className="py-20 relative bg-white dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 relative">
          <div className="inline-block mb-2 px-3 py-1 bg-customBlue-50 dark:bg-customBlue-900/30 text-customBlue-600 dark:text-customBlue-300 text-sm font-medium rounded-full">
            My Work
          </div>
          <div className="inline-block relative">
            <div className="absolute -top-10 -right-10 text-6xl text-customBlue-100 dark:text-customBlue-900/30 font-bold opacity-30">
              {projects.length}
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8 stagger-children">
            <Button
              ...
              className={
                activeFilter === null
                  ? "bg-customBlue-500 text-white rounded-md"
                  : "hover:bg-customBlue-50 dark:hover:bg-customBlue-900/30 rounded-md"
              }
            >
              All Projects
            </Button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-children">
          {filteredProjects.map((project, index) => (
            ...
            >
              {/* Image container wrapper with fixed aspect and imageClassName override */}
              <div className="aspect-[4/3] w-full bg-white dark:bg-gray-800 rounded-lg overflow-hidden mb-4">
                <img
                  src={project.image}
                  alt={project.title}
